...
const double DH_d6 = 0.082; //0.072
...
const double DH_q_max6 = deg2rad*400; //deg2rad*400; //deliberately reduce this, to avoid excess solutions
...
const double DH_q_min6 = -deg2rad*400; //-deg2rad*400;
